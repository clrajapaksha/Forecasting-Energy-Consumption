...
# estimator = KerasRegressor(build_fn=baseline_model, nb_epoch=100, batch_size=50, verbose=0)
# 
...
kr = KerasRegressor(build_fn=baseline_model, nb_epoch=100, batch_size=50, verbose=0)
...
# Save the weights
kr.model.save('model_weights.h5')
